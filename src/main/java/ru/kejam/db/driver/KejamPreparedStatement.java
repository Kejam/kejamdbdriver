...
@Slf4j
public class KejamPreparedStatement  implements PreparedStatement {
    private final OkHttpClient client = new OkHttpClient();
    private final ObjectMapper objectMapper = new ObjectMapper();
    private final String urlExecuteQuery = "executeQuery";
    private final String sql;

    public KejamPreparedStatement(String sql) {
        this.sql = sql;
    }
    ...
    public ResultSet executeQuery() throws SQLException {
        ...
        final RequestBody executeBody = new FormBody.Builder()
                .add("sql", sql)
                .build();
        final Request executeRequest = new Request.Builder()
                .url(KejamDatabaseDriver.getUrl() + urlExecuteQuery)
                .post(executeBody)
                .build();
        final Call call = client.newCall(executeRequest);
        try {
